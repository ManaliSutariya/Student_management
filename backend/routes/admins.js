...
router.get('/delete_course/:id',auth.admin,admin.delete_course);
router.post('/update_course/:id',auth.admin,admin.update_course);
router.get('/view_course/:id',auth.admin,admin.view_course);
router.post('/update_language/:id',auth.admin,admin.update_language);
router.get('/delete_language/:id',auth.admin,admin.delete_language);
