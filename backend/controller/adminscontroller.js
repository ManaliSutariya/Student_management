...
exports.delete_course = async(req,res)=>{
    var id= req.params.id;
    var data = await coursedb.findByIdAndDelete(id);
    res.status(200).json({
...
exports.update_course = async(req, res)=>{
    var id= req.params.id;
    var data = await coursedb.findByIdAndUpdate(id,req.body);
    res.status(200).json({
...
exports.view_course = async(req,res)=>{
    var id = req.params.id;
    var data = await coursedb.findById(id).populate("languages");
    res.status(200).json({
        status:"view course",
        data
    })
...
exports.update_language = async(req,res)=>{
    var id = req.params.id;
    var data = await languagedb.findByIdAndUpdate(id,req.body);
    res.status(200).json({
...
exports.delete_language = async(req,res)=>{
    var id = req.params.id;
    var data = await languagedb.findByIdAndDelete(id);
    res.status(200).json({
